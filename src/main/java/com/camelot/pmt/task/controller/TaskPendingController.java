...
public class TaskPendingController {
    ...
    /**
     * 查询被指派人的顶级任务名称列表 @Title: queryTopTaskNameList @Description:
    ...
    public JSONObject updateTaskPendingToDelay(
        ...
        try {
            ...
            // 更新我的待办任务为正在进行中
            result = taskPendingService.updateTaskPendingToDelay(id, TaskStatus.OVERDUE.getValue(), delayDescribe,
                    estimateStartTime);
            // 判断是否成功
            if (result.isSuccess()) {
                return ApiResponse.jsonData(APIStatus.OK_200, result.getResult());
    ...
    /**
     * 无用接口 @Title: addUser @Description: TODO(添加Task对象接口方法) @param @param
    ...
    /**
     * 无用接口 @Title: deleteTask @Description:
    ...
    /**
     * 无用接口 @Title: deletePendingTaskTreeById @Description:
    ...
    /**
     * 无用接口 @Title: addUser @Description: TODO(添加或更新Task对象接口方法) @param @param
     * task @param @return 设定文件 @return JSONObject 返回类型 @throws
     */
    /*
     ...
     * @ApiImplicitParams({
     * 
     * @ApiImplicitParam(name = "id", value = "任务标识号", required = true, paramType =
     * "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "taskName", value = "任务名称", required = true,
     * paramType = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "taskParentId", value = "父级任务标识号", required = true,
     * paramType = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "projectId", value = "项目标识号", required = true,
     * paramType = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "demandId", value = "需求标识号", required = true,
     * paramType = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "priority", value = "优先级", required = true,
     * paramType = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "assignUserId", value = "指派人标识号", required = true,
     * paramType = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "beassignUserId", value = "负责人", required = true,
     * paramType = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "assignTime", value = "任务指派时间", required = true,
     * paramType = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "estimateStartTime", value = "任务预期开始时间", required =
     * true, paramType = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "estimateEndTime", value = "任务预期结束时间", required =
     * true, paramType = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "actualStartTime", value = "任务实际开始时间", required =
     * true, paramType = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "actualEndTime", value = "任务实际结束时间", required =
     * true, paramType = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "taskType", value = "任务类型", required = true,
     * paramType = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "taskSpeed", value = "任务进度", required = true,
     * paramType = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "status", value = "任务状态", required = true, paramType
     * = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "abnormalStatus", value = "异常状态", required = true,
     * paramType = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "estimateHour", value = "任务预计工时", required = true,
     * paramType = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "consumeHour", value = "任务已消耗工时", required = true,
     * paramType = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "remainHour", value = "任务剩余工时", required = true,
     * paramType = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "taskMileage", value = "任务里程", required = true,
     * paramType = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "warningHour", value = "预警工时", required = true,
     * paramType = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "warningStatus", value = "预警状态", required = true,
     * paramType = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "comment", value = "备注", required = true, paramType
     * = "form", dataType = "String"),
     * 
     * @ApiImplicitParam(name = "filepath", value = "附件路径", required = true,
     * paramType = "form", dataType = "String"),
     * 
     ...
     * ExecuteResult<String> result = new ExecuteResult<String>(); try { Long
     * userLoginId = Long.valueOf(1); //检查用户是否登录，需要去session中获取用户登录信息
     * if(StringUtils.isEmpty(userLoginId)){ return
     * ApiResponse.jsonData(APIStatus.UNAUTHORIZED_401); } //对象检查是否为空 if (task ==
     * null) { return ApiResponse.jsonData(APIStatus.ERROR_400, result.getResult());
     * } result = taskPendingService.save(task); //判断是否成功 if (result.isSuccess()) {
     * return ApiResponse.jsonData(APIStatus.OK_200, result.getResult()); } return
     * ApiResponse.error(); }catch (Exception e) { //异常错误 return
     * ApiResponse.jsonData(APIStatus.ERROR_500, e.getMessage()); } }
     */

    /**
     * 无用接口 @Title: queryTaskTreeByTaskId @Description:
     ...
     * 
     * @RequestMapping(value = "/queryTaskTreeByTaskId", method =
     * RequestMethod.POST) public JSONObject queryTaskTreeByTaskId(
     * 
     * @ApiParam(name = "taskId", value = "任务标识号", required =
     * true) @RequestParam(required = true) String taskId){ ExecuteResult<Task>
     * result = new ExecuteResult<Task>(); try { Long userLoginId = Long.valueOf(1);
     * //检查用户是否登录，需要去session中获取用户登录信息 if(StringUtils.isEmpty(userLoginId)){ return
     * ApiResponse.jsonData(APIStatus.UNAUTHORIZED_401); } result =
     * taskPendingService.queryTaskTreeByTaskId(Long.valueOf(taskId),TaskType.
     * PENDINHG.getValue(),userLoginId); //判断是否成功 if(result.isSuccess()){ return
     * ApiResponse.jsonData(APIStatus.OK_200,result.getResult()); } return
     * ApiResponse.error(); }catch (Exception e) { //异常 return
     * ApiResponse.jsonData(APIStatus.ERROR_500,e.getMessage()); } }
     */
