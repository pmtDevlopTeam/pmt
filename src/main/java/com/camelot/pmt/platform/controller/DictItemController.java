...
public class DictItemController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "dictIds", value = "字典ID", required = true, paramType = "form", dataType = "String"), })
    @RequestMapping(value = "/createDictItem", method = RequestMethod.POST)
    public JSONObject createDictItem(@ApiIgnore @RequestParam(required = true) String dictIds,
            @ApiIgnore DictItem dictItem) {
    ...
    public JSONObject queryListDictItemByDictId(
            @ApiParam(value = "字典项dictId", required = true) @RequestParam(required = true) String dictId) {
    ...
    @ApiImplicitParams({ @ApiImplicitParam(name = "page", value = "页码", paramType = "query", dataType = "int"),
            @ApiImplicitParam(name = "rows", value = "每页数量", paramType = "query", dataType = "int") })
    public JSONObject queryListDictItemByDictIdPage(
            @ApiParam(value = "字典项dictId", required = true) @RequestParam(required = true) String dictId,
            @ApiIgnore Pager page) {
