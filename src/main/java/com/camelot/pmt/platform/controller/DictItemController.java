...
public class DictItemController {
    ...
    public JSONObject selectDictItemListByDictId(@ApiIgnore @RequestParam(required = true) String dictId,
    ...
    public JSONObject selectDictItemListAll(@ApiIgnore DictItem dictItem,
