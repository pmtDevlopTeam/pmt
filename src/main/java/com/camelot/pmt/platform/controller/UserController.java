...
public class UserController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "roleId", value = "用户角色ID", required = false, paramType = "form", dataType = "String"),
            ...
            @ApiImplicitParam(name = "createUserId", value = "用户创建人ID", required = true, paramType = "form", dataType = "String"),
            @ApiImplicitParam(name = "modifyUserId", value = "用户修改人ID", required = false, paramType = "form", dataType = "String") })
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "state", value = "用户状态", required = false, paramType = "form", dataType = "String"),
    ...
    public JSONObject deleteUserByUserId(@ApiIgnore User userModel) {
        ExecuteResult<String> result = new ExecuteResult<String>();
        try {
            if ("".equals(userModel.getUserId()) || "0".equals(userModel.getUserId())
    ...
    // @ApiImplicitParams({
    // @ApiImplicitParam(name = "page", value = "页码", required = false, paramType =
    // "query", dataType = "int"),
    // @ApiImplicitParam(name = "rows", value = "每页数量", required = false, paramType
    // = "query", dataType = "int")
    // })
