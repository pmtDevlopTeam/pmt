...
public class VersionController {
    ...
    public JSONObject findVerListByPageAndProIdAndVerType(@ApiIgnore Pager<?> page, Long projectId,
            String versionType) {
        return versionService.findVerListByPageAndProIdAndVerType(page.getPage(), page.getRows(), projectId,
                versionType);
    }
}
